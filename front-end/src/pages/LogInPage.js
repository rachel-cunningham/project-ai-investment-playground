...
export default function ExampleLoginPage() {
  ...
  return (
    ...
    >
      ...
      <Typography
        color="white"
        sx={{ fontSize: "48px", textAlign: "center", mt: 1 }}
      >
        Welcome Back
      </Typography>
      <Button
        ...
        variant="contained"
        color="primary"
        sx={{ fontFamily: "MavenPro", textTransform: "none", mt: 1, mb: 1 }}
      >
        Create User
      </Button>
      <form
      ...
      >
        ...
        <Button
          ...
          color="primary"
          fullWidth
          sx={{ fontFamily: "MavenPro", textTransform: "none", mt: 2 }}
        >
          Log In
        </Button>
      </form>
      <Box sx={{ width: "100%", maxWidth: "400px", mt: { xs: 5, sm: 0 } }}>
